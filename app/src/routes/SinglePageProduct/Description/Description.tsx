...
const Description: FC = () => {
    ...
    return (
        <div className={classes.description}>
            ...
            <p className={classes.description_text}>{selectedProduct?.description}</p>
            ...
            <Link to="#" className={classes.description_more_link}>Читать дальше <img src={moreIcon} alt="" /></Link>
        </div>
    )
}
