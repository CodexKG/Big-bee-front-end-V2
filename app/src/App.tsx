  ...
  return (
    <Routes>
      ...
      <Route path='/' element={<Main />}>
        ...
        <Route path='/catalog/:id' element={<Suspense fallback={<Spin fullscreen />}>
          <Catalog />
        </Suspense>} />
        <Route path='/favorites' element={<Favorites />} />
        <Route path='/orderplasing' element={<Protected fallback={<NoLogin></NoLogin>}><OrderPlacing /></Protected>} />
        <Route path='/product/:id' element={<Suspense fallback={<Spin fullscreen />}><SinglePageProduct /></Suspense>} />
